...
def prepare_lstm_input(train_df, test_df, target_col):
...
def preprocess_for_lstm(train_path, test_path, output_dir):
    target_col = '임신 성공 여부'
    ...
    X_train, X_val, X_test, y_train, y_val = prepare_lstm_input(train_df, test_df, target_col)
...
output_dir = "/content/drive/MyDrive/open/LSTM/preprocessed_data"
preprocess_for_lstm(train_path, test_path, output_dir)
